...
namespace Application.Manager.Implementation.ContactModule
{
    public class ContactManager : IContactManager
    {
        ...
        public List<ProfileDTO> FindProfiles(int pageIndex, int pageCount)
        {
            ...
            {
                var lstProfileDTO = new List<ProfileDTO>();
                foreach (var profile in profiles)
                {
                    lstProfileDTO.Add(Conversion.ContactModule.Mapping.ProfileToProfileDTO(profile, addressTypes, phoneTypes));
                }
        ...
        public void DeleteProfile(int profileId)
        {
            ...
            if (profile != null) //if profile exist
            {
                ...
                LoggerFactory.CreateLog().LogWarning(LocalizerFactory.CreateLocalizer().GetString("warning_CannotRemoveNonExistingProfile", typeof(ApplicationErrors)));
        }
        ...
        public ProfileDTO FindProfileById(int id)
        {
            ...
            if (profile != null)
            {
                return Conversion.ContactModule.Mapping.ProfileToProfileDTO(profile, addressTypes, phoneTypes);
            }
            else //no data
        ...
        public ContactForm InitializePageData()
        {
            ...
            objContactForm.lstAddressTypeDTO = Conversion.ContactModule.Mapping.AddressTypeToAddressTypeDTO(addressTypes);
            objContactForm.lstPhoneTypeDTO = Conversion.ContactModule.Mapping.PhoneTypeToPhoneTypeDTO(phoneTypes);
